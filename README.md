...
### AML dataset
The gene expression data and other associated information for the AML dataset were sourced from the study by Wang et al. and are available in Supplementary Tables 5 and 7 of their paper.

Wang et al. Integrative proteogenomic and pharmacological landscape of acute myeloid leukaemia. 
Sci. Bull. 70, 1051-1056 (2025). https://doi.org/10.1016/j.scib.2024.11.020

### TCGA dataset
The sensitivity data for the TCGA dataset were obtained from the supplementary data of the study by Ding et al.

Ding, Z., Zu, S. & Gu, J. Evaluating the molecule-based prediction of clinical drug
responses in cancer. Bioinformatics 32, 2891-2895 (2016). https://doi.org/10.1093/bioinformatics/btw344

The endpoint information used for survival analysis was sourced from Liu et al. and is available in their Table S1.

Liu, J. et al. An Integrated TCGA Pan-Cancer Clinical Data Resource to Drive High-Quality Survival 
Outcome Analytics. Cell 173, 400-416.e411 (2018). https://doi.org/10.1016/j.cell.2018.02.052
...
- We strictly adhered to the original hyperparameter settings of each model. 
- The only modification involved adapting the data loading pipeline to accommodate our standardized input format and the data partitions generated by data/data_split.ipynb. 
...
**CANDELA**: https://zenodo.org/doi/10.5281/zenodo.8020945
...
**DTLCDR**: https://github.com/yujie0317/DTLCDR
...
**Precily**: https://github.com/SmritiChawla/Precily
